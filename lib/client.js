...
var pkg = require('../node_modules/surge/package.json')
...
function toolbar(version){
  ...
  credits.innerText = pkg.name.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();}) + ' v' + pkg.version;
